package com.itheima.databindingdemo;
...
public class FlowLayout extends ViewGroup {
    ...
    class Line {
        ...
        public void defalutTextView(View view){
            if(view instanceof TextView){
                ...
                int argb=0xFF000000|random.nextInt(0x00BBBBBB);
